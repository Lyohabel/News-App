            ...
            <div className="container">
                <div className={styles.wrapper}>
                    <div className={styles.typeChoose}>
                        ...
                        <span className={styles.keys}>ae ar  at  au  be  bg  br  ca  ch  cn  co  cu  cz  de  eg  fr  gb  gr  hk  hu  id  ie  il  in  it  jp  kr  lt  lv  ma  mx  my  ng  nl  no  nz  ph  pl  pt  ro  rs  ru  sa  se  sg  si  sk  th  tr  tw  ua  us  ve  za</span></p>
...
// `https://newsapi.org/v2/top-headlines?country=${country}&apiKey=c5c59399c298440c8978f43a60953157`

// ae ar at au be bg br ca ch cn co cu cz de eg fr gb gr hk hu id ie il in it jp kr lt lv ma mx my ng nl no nz ph pl pt ro rs ru sa se sg si sk th tr tw ua us ve za

// `https://newsapi.org/v2/top-headlines?sources=${sourses}&apiKey=c5c59399c298440c8978f43a60953157`

// abc-news al-jazeera-english associated-press bbc-news bbc-sport bild bloomberg business-insider cnn crypto-coins-news die-zeit fox-news google-news hacker-news independent le-monde lenta national-geographic news24 new-scientist newsweek nhl-news rbc reuters spiegel-online the-jerusalem-post the-wall-street-journal the-washington-post time usa-today